...
class Lattice:
    ...
    def charge_up(self):
        ...
        # Place polymer 
        conformer = 2 # 2 -- 1 is straight, 2 is 90 deg bend, 3 is extended
...
np.savetxt("entropy_12_2.txt",entropy)
np.savetxt("histogram_12_2.txt",hist)
np.savetxt("energy_store_12_2.txt",energy_store)
np.savetxt("energy_edges_12_2.txt",z1.energy_edges)
