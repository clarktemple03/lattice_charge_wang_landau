...
np.savetxt("entropy_6_3.txt",entropy)
np.savetxt("histogram_6_3.txt",hist)
np.savetxt("energy_store_6_3.txt",energy_store)
np.savetxt("energy_edges_6_3.txt",z1.energy_edges)
