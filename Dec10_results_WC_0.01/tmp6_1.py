...
np.savetxt("entropy_6_1.txt",entropy)
np.savetxt("histogram_6_1.txt",hist)
np.savetxt("energy_store_6_1.txt",energy_store)
np.savetxt("energy_edges_6_1.txt",z1.energy_edges)
