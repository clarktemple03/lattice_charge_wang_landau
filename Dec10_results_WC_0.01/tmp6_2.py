...
np.savetxt("entropy_6_2.txt",entropy)
np.savetxt("histogram_6_2.txt",hist)
np.savetxt("energy_store_6_2.txt",energy_store)
np.savetxt("energy_edges_6_2.txt",z1.energy_edges)
