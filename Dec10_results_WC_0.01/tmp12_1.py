...
class Lattice:
    ...
    def charge_up(self):
        ...
        # Place polymer 
        conformer = 1 # 1 -- 1 is straight, 2 is 90 deg bend, 3 is extended
...
np.savetxt("entropy_12_1.txt",entropy)
np.savetxt("histogram_12_1.txt",hist)
np.savetxt("energy_store_12_1.txt",energy_store)
np.savetxt("energy_edges_12_1.txt",z1.energy_edges)
